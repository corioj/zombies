...
public:
    ...
    virtual void push(const TYPE & val) {
        // TODO: Implement this function
        // go over this
        typename std::vector<TYPE>::iterator insertionit;
        insertionit = std::lower_bound(data.begin(), data.end(), val, this->compare);
        data.insert(insertionit, val);
    } // push()
    ...
    virtual const TYPE & top() const {
        ...
        return data.back(); // does this return by reference?
    ...
    virtual void updatePriorities() {
        ...
        std::sort(data.begin(), data.end(), this->compare); // good?
